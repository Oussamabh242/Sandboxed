...
{"function":{"name":"lengthOfLongestSubstring","parameters":[{"name":"s","type":"string"}],"return_type":"int","description":"Finds the length of the longest substring without repeating characters."},"test_cases":[{"input":"abcabcbb","expected_output":3},{"input":"bbbbb","expected_output":1},{"input":"pwwkew","expected_output":3},{"input":"","expected_output":0}]}
